    ...
    public onMultipleRowClick = (id: number, isShiftClicked?: boolean): void => {
        ...
        if (isShiftClicked) {
            ...
            if (this.state.selectedRow !== undefined) {
                ...
                const lastSelectedRowIndex = getIndexOfNode(this.state.selectedRow, tree, this.state.collapsedNodes, this.state.emptyNodes);
            ...
            if (rows.includes(id)) {
                ...
                if (id === this.state.selectedRow) {
                    ...
                    if (prevRowId && prevRowId !== id) {
                        const prevRowIndex = getIndexOfNode(prevRowId, tree, this.state.collapsedNodes, this.state.emptyNodes);
